...
const Candidates = () => {
  ...
  const [columnDefs] = useState<ColDef<CandidateRow>[]>([
    ...
    { headerName: "Phone", field: "phone", width: 90 },
    { headerName: "Course", field: "course", width: 40 },
    { headerName: "Enrolled Date", field: "enrolleddate", width: 70 },
    {
      headerName: "Status",
      field: "status",
      width: 70,
    ...
    { headerName: "Status Change Date", field: "statuschangedate", width: 70 },
    { headerName: "Process", field: "processflag", width: 50 },
    { headerName: "Dice Candidate", field: "diceflag", width: 50 },
    { headerName: "US Status", field: "workstatus", width: 70 },
    { headerName: "Education", field: "education", width: 90 },
    { headerName: "Work Experience", field: "workexperience", width: 90 },
    { headerName: "SSN", field: "ssn", width: 90 },
    { headerName: "Birth Date", field: "dob", width: 70 },
    { headerName: "Portal ID", field: "portalid", width: 200 },
    { headerName: "Work Auth Exp Date", field: "wpexpirationdate", width: 115 },
    { headerName: "SSN Valid", field: "ssnvalidated", width: 60 },
    { headerName: "BGV Done", field: "bgv", width: 60 },
    { headerName: "Sec Email", field: "secondaryemail", width: 150 },
    { headerName: "Secondary Phone", field: "secondaryphone", width: 90 },
    { headerName: "Address", field: "address", width: 150 },
    { headerName: "City", field: "city", width: 90 },
    { headerName: "State", field: "state", width: 90 },
    ...
    { headerName: "Emeg: Contact Address", field: "emergcontactaddrs", width: 150 },
    { headerName: "Term", field: "term", width: 90 },
    { headerName: "Fee Paid", field: "feepaid", width: 90 },
    { headerName: "Fee Due", field: "feedue", width: 90 },
    { headerName: "Referral ID", field: "referralid", width: 200 },
    { headerName: "Salary0-6", field: "salary0", width: 70 },
    { headerName: "Salary6-12", field: "salary6", width: 70 },
    { headerName: "Salary12+", field: "salary12", width: 70 },
    { headerName: "Resume Url", field: "originalresume", width: 200 },
    { headerName: "Contract Url", field: "contracturl", width: 200 },
    { headerName: "Emp Agreement Url", field: "empagreementurl", width: 200 },
    { headerName: "Offer Letter Url", field: "offerletterurl", width: 200 },
    { headerName: "DL Url", field: "dlurl", width: 200 },
    { headerName: "Work Permit Url", field: "workpermiturl", width: 200 },
    { headerName: "SSN Url", field: "ssnurl", width: 200 },
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      sortedBatchNames.forEach(batchName => {
        ...
        if (expandedGroups[batchName] !== false) { // Changed to check for explicit false
          rows.push(...grouped[batchName]);
        }
      });
    ...
    <div className="relative">
      <div className="p-2 sm:p-4 mt-16 sm:mt-20 mb-6 sm:mb-10 mx-auto bg-gray-100 rounded-lg shadow-md relative max-w-full sm:max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-center mb-3 sm:mb-4">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800">Candidate Management</h1>
        </div>
