...
//         }
//       );
//       setMonthGroups(response.data.data);
...
//       setIsLoading(false);
//     }
//   }, [currentPage, debouncedSearchValue, selectedMonth]);
...
//         clients={clients}
//         defaultClientId={
//           selectedMonth || modalState.selectedRow?.poid || 0
//         }
//       />
//     </div>
//   );
...
const ByMonth = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      if (response.data && response.data.data) {
        console.log("Setting monthGroups:", response.data.data);
        setMonthGroups(response.data.data);
        setTotalPages(response.data.pages);
      } else {
  ...
  useEffect(() => {
    console.log("MonthGroups state:", monthGroups);
