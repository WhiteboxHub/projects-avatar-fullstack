...
// import EditRowModal from "@/modals/recruiter_byClient_modals/EditRowRecruiter"; // Import the EditRowModal
// import {
//   FaChevronLeft,
//   FaChevronRight,
//   FaAngleDoubleLeft,
...
//     edit: boolean;
//     view: boolean;
//     editRow: boolean; // Add state for editRow modal
//   }>({ add: false, edit: false, view: false, editRow: false });
...
//         rows.push({
//           id: -1, // Changed from null to -1 to avoid type error
//           name: "",
//           email: "",
//           phone: "",
//           designation: "",
...
//           review: "",
//           notes: "",
//           clientid: -1, // Changed from null to -1 to avoid type error
//           companyname: "",
//           isGroupRow: false,
//           level: 1,
//         });
...
//       setModalState((prev) => ({ ...prev, editRow: false })); // Close editRow modal
//       fetchData();
//     } catch (error) {
...
//       .filter((row) => !row.isGroupRow && row.id !== -1) // Changed from null to -1
//       .map((row) => [
//         row.companyname,
//         row.name,
//         row.email,
...
//   function onGridReady(event: any): void {
//     // Implement grid ready logic if needed
//   }

//   function onPaginationChanged(event: any): void {
//     // Implement pagination changed logic if needed
//   }
...
//                 setModalState((prev) => ({ ...prev, editRow: true })); // Open editRow modal
//               } else {
...
//           rowSelection="single" // Change to single selection
//           rowHeight={30}
//           headerHeight={35}
//           onGridReady={(params) => {
...
//       <EditRowModal
//         isOpen={modalState.editRow}
//         onClose={() => setModalState((prev) => ({ ...prev, editRow: false }))}
//         onSubmit={handleEdit}
//         recruiter={selectedRow}
//         clientOptions={companies.map((c) => ({
//           id: c.clientid,
