    ...
    <div className="p-4 mt-20 mb-10 ml-20 mr-20 bg-gray-100 rounded-lg shadow-md relative">
      ...
      >
        <AgGridReact
          ...
          columnDefs={[
            ...
            { headerName: "Facebook", field: "facebook" },
            { headerName: "Review", field: "review" },
            { headerName: "Client ID", field: "clientid", rowGroup: true, hide: true },
            { headerName: "Notes", field: "notes" },
          ]}
          pagination={false}
          domLayout="normal"
          ...
          autoGroupColumnDef={{
            ...
            cellRendererParams: {
              innerRenderer: (params: { node: { key: any; }; }) => params.node.key, // Display client name
            },
          }}
      ...
      {modalState.add && (
        <AddRowModal
          ...
          onClose={() => setModalState((prev) => ({ ...prev, add: false }))}
          onSubmit={() => {
            fetchRecruiters(currentPage); // Refresh data after adding
          }}
        />
      )}
      {modalState.edit && selectedRow && (
        <EditRowModal
          ...
          initialData={selectedRow}
          onSubmit={() => {
            fetchRecruiters(currentPage); // Refresh data after editing
          }}
        />
      )}
      {modalState.view && selectedRow && (
