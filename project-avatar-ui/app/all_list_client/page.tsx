...
//       try {
//         await axios.delete(
//           `${API_URL}/by/recruiters/byAllList/remove/${selectedRows[0].id}`,
//           { headers: { AuthToken: localStorage.getItem("token") } }
//         );
...
//     XLSX.writeFile(workbook, "recruiters_data.xlsx");
//   };
...
//   const iconSize = windowWidth < 640 ? "text-xs" : windowWidth < 1024 ? "text-sm" : "text-base";
//   const buttonPadding = windowWidth < 640 ? "p-1.5" : windowWidth < 1024 ? "p-2" : "p-2.5";
...
//         <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">Recruiter Management</h1>
...
//             className={`flex items-center justify-center ${buttonPadding} bg-blue-600 text-white rounded-md ml-2 hover:bg-blue-700 text-xs sm:text-sm`}
//           >
//             <AiOutlineSearch className={iconSize} />
//           </button>
//         </div>
//       </div>
...
// function autoTable(doc: jsPDF, arg1: { head: string[][]; body: (string | number)[][]; }) {
    ...
    <div className="relative">
      ...
      <div className="p-2 sm:p-4 mt-16 sm:mt-20 mb-6 sm:mb-10 mx-2 sm:mx-4 md:mx-8 lg:mx-12 xl:mx-16 bg-gray-100 rounded-lg shadow-md relative">
        <div className="flex flex-col md:flex-row justify-between items-center mb-3 sm:mb-4">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800">Recruiter Management</h1>
