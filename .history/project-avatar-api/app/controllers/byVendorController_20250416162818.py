  ...
  const setupColumns = (data: Vendor[]) => {
    if (data.length > 0) {
      const columns = [
        ...
        { headerName: "Total Net Term", field: "totalnetterm", width: 70, editable: true, editoptions: { defaultValue: 45 }, label: "Net" },
        { headerName: "Defaulted Payment", field: "defaultedpayment", width: 50, editable: true, label: "Defaulted", edittype: "select" },
        { headerName: "URL", field: "url", width: 200, editable: true, editoptions: { size: 75, maxlength: 200, style: "text-transform: lowercase" }, formatter: "link", formatoptions: { target: "_blank" }, label: "Url" },
        ...
        { headerName: "Phone", field: "phone", width: 150, editable: true, label: "Phone" },
        { headerName: "Fax", field: "fax", width: 150, editable: true, label: "Fax" },
        { headerName: "Address", field: "address", width: 150, editable: true, label: "Address" },
        { headerName: "City", field: "city", width: 120, editable: true, label: "City" },
        { headerName: "State", field: "state", width: 120, editable: true, label: "State" },
        { headerName: "Country", field: "country", width: 120, editable: true, label: "Country" },
        { headerName: "Zip", field: "zip", width: 120, editable: true, label: "Zip" },
        ...
        { headerName: "Timesheet Email", field: "timesheetemail", width: 150, editable: true, formatter: "email", label: "Time Sheet Email" },
        ...
        { headerName: "Agreement Link", field: "agreementlink", width: 200, editable: true, formatter: "link", formatoptions: { target: "_blank" }, label: "Agreement Url" },
        { headerName: "Subcontractor Link", field: "subcontractorlink", width: 200, editable: true, formatter: "link", formatoptions: { target: "_blank" }, label: "Sub Contractor Url" },
        { headerName: "Nonsolicitation Link", field: "nonsolicitationlink", width: 200, editable: true, formatter: "link", formatoptions: { target: "_blank" }, label: "NSA Url" },
        { headerName: "Nonhire Link", field: "nonhirelink", width: 200, editable: true, formatter: "link", formatoptions: { target: "_blank" }, label: "Non Hire Url" },
