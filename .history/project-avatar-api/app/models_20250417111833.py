...
class Vendor(Base):
    ...
    tier = Column(I, nullable=True)
    culture = Column(String, nullable=False, default='D')
    solicited = Column(String, nullable=False, default='N')
    minrate = Column(Integer, nullable=False, default=62)
    hirebeforeterm = Column(String, nullable=False, default='N')
    hireafterterm = Column(String, nullable=False, default='N')
    latepayments = Column(String, nullable=False, default='N')
    totalnetterm = Column(Integer, nullable=False, default=45)
    defaultedpayment = Column(String, nullable=False, default='N')
    agreementstatus = Column(String, nullable=False, default='Not Available')
    accountnumber = Column(String, nullable=True)
    url = Column(String, nullable=False, unique=True, default='http://nothing.com')
