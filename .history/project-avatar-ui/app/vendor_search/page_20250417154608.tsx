                  ...
                  {vendors.map((vendor) => (
                    <li key={vendor.id} className="mb-4">
                      <Dropdown
                        ...
                        isOpen={openAccordion[String(vendor.id)] === "company"} // Convert to string
                        onClick={() => toggleAccordion(String(vendor.id), "company")} // Convert to string
                      >
                      ...
                      <Dropdown
                        title="Contact"
                        isOpen={openAccordion[String(vendor.id)] === "contact"} // Convert to string
                        onClick={() => toggleAccordion(String(vendor.id), "contact")} // Convert to string
                      >
                        <p className="font-medium">
                      ...
                      <Dropdown
                        title="Notes"
                        isOpen={openAccordion[String(vendor.id)] === "notes"} // Convert to string
                        onClick={() => toggleAccordion(String(vendor.id), "notes")} // Convert to string
                      >
                      ...
                      <Dropdown
                        ...
                        isOpen={openAccordion[String(vendor.id)] === "additional"} // Convert to string
                        onClick={() => toggleAccordion(String(vendor.id), "additional")} // Convert to string
                      >
                        <p className="font-medium">
