...
import AddRowModal from "@/modals/recruiter_byVendorList_modals/AddRowRecruiter";
import EditRowModal from "@/modals/recruiter_byVendorList_modals/EditRowRecruiter";
import React, { useCallback, useEffect, useRef, useState } from "react";
import ViewRowModal from "@/modals/recruiter_byVendorList_modals/ViewRowRecruiter";
...
const RecruiterByVendorList = () => {
  ...
  const fetchRecruiters = async (page: number, search?: string) => {
    ...
    try {
      ...
      const response = await axios.get(`${API_URL}/by/recruiters/byVendorList`, {
