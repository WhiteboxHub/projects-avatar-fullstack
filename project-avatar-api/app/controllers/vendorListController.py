...
class VendorController:
    ...
    async def get_vendors(self, page: int, page_size: int, search: Optional[str] = None):
        query = self.db.query(
            ...
            Vendor.solicited, Vendor.minrate, Vendor.hirebeforeterm, Vendor.hireafterterm,
            Vendor.latepayments, Vendor.totalnetterm, Vendor.defaultedpayment, Vendor.agreementstatus,
            Vendor.url, Vendor.email, Vendor.phone, Vendor.fax, Vendor.address, Vendor.city,
            Vendor.state, Vendor.country, Vendor.zip, Vendor.hrname, Vendor.hremail,
            Vendor.hrphone, Vendor.twitter, Vendor.facebook, Vendor.linkedin, Vendor.accountnumber,
            Vendor.managername, Vendor.manageremail, Vendor.managerphone, Vendor.secondaryname,
            Vendor.secondaryemail, Vendor.secondaryphone, Vendor.timsheetemail, Vendor.agreementname,
            Vendor.agreementlink, Vendor.subcontractorlink, Vendor.nonsolicitationlink, Vendor.nonhirelink,
            Vendor.clients, Vendor.notes
        )
