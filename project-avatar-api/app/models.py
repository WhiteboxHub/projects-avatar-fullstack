...
class Vendor(Base):
    ...
    solicited = Column(String(10))
    minrate = Column(Float)
    hirebeforeterm = Column(String(10))
    hireafterterm = Column(String(10))
    latepayments = Column(String(10))
    totalnetterm = Column(Integer)
    defaultedpayment = Column(String(10))
    agreementstatus = Column(String(50))
    ...
    hrname = Column(String(100))
    hremail = Column(String(255))
    hrphone = Column(String(50))
    managername = Column(String(100))
    manageremail = Column(String(255))
    managerphone = Column(String(50))
    secondaryname = Column(String(100))
    secondaryemail = Column(String(255))
    secondaryphone = Column(String(50))
    agreementname = Column(String(255))
    agreementlink = Column(String(255))
    subcontractorlink = Column(String(255))
    nonsolicitationlink = Column(String(255))
    nonhirelink = Column(String(255))
    clients = Column(Text)
    notes = Column(Text)
    crawldate = Column(DateTime)
    lastmoddatetime = Column(DateTime, server_default=func.now(), onupdate=func.now())
